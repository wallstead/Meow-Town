...
class Cat: NSObject, NSCoding {
    ...
    required convenience init(coder decoder: NSCoder) {
        self.init()
        self.being = decoder.decodeObjectForKey("being") as! Being
        self.world = decoder.decodeObjectForKey("age") as! World
        self.sprite = decoder.decodeObjectForKey("age") as! SKPixelSpriteNode
...
//    convenience init(name: String, skin: String, inWorld: World) {
//        self.init()
//        
//        self.world = inWorld;
//        
